            ...
            <div id="rev-slider1" class="rev_slider fullwidthabanner">
                <ul>                   
                    ...
                    <li data-transition="random">
                        <!-- Main Image -->
                        <img src="{{url('frontend/images/slider/slider-bg-5.jpg')}}" alt="" data-bgposition="center center" data-no-retina>
                    ...
                    <li data-transition="random">
                        <!-- Main Image -->
                        <img src="{{url('frontend/images/slider/slider-bg-1.jpg')}}" alt="" data-bgposition="center center" data-no-retina>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="flat-image-box style-1 data-effect div-h22 clearfix">
                            <div class="item data-effect-item">
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="{{url('frontend/images/image-box/imgbox-1-375x500.jpg')}}" alt="Image">
                                        <div class="elm-btn">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="flat-image-box style-1 row2 data-effect clearfix">
                            <div class="item data-effect-item">
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="{{url('frontend/images/image-box/imgbox-1-375x240.jpg')}}" alt="Image">
                                        <div class="elm-btn">
                            ...
                            <div class="item data-effect-item">
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="{{url('frontend/images/image-box/imgbox-2-375x240.jpg')}}" alt="Image">
                                        <div class="elm-btn">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="flat-image-box style-1 data-effect div-h20 clearfix">
                            <div class="item data-effect-item">
                                <div class="inner">
                                    <div class="thumb">
                                        <img src="{{url('frontend/images/image-box/imgbox-2-375x500.jpg')}}" alt="Image">
                                        <div class="elm-btn">
                        ...
                        <div class="product-content product-fourcolumn clearfix">
                            <ul class="product style2 clearfix">
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/13.jpg')}}" alt="image">
                                        </a>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/14.jpg')}}" alt="image">
                                        </a>
                                        <span class="new">New</span>
                                    </div>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/15.jpg')}}" alt="image">
                                        </a>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/16.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                    <div class="product-info clearfix">
                                        <span class="product-title">Cotton White Underweaer Block Out Edition</span>
                        ...
                        <div class="product-content product-fourcolumn clearfix">
                            <ul class="product style2 isotope-product clearfix">
                                <li class="product-item kid woman">
                                    <div class="product-thumb clearfix">
                                        <a href="#">
                                            <img src="{{url('frontend/images/shop/sh-4/1.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                    <div class="product-info clearfix">
                                        <span class="product-title">Cotton White Underweaer Block Out Edition</span>
                                ...
                                <li class="product-item man accessories">
                                    <div class="product-thumb clearfix">
                                        <a href="#">
                                            <img src="{{url('frontend/images/shop/sh-4/2.jpg')}}" alt="image">
                                        </a>
                                        <span class="new">New</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item kid woman">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/3.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                    <div class="product-info clearfix">
                                        <span class="product-title">Cotton White Underweaer Block Out Edition</span>
                                ...
                                <li class="product-item man accessories">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/4.jpg')}}" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item kid woman">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/5.jpg')}}" alt="image">
                                        </a>
                                        <span class="new">New</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item man accessories">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/6.jpg')}}" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item kid woman">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/7.jpg')}}" alt="image">
                                        </a>
                                    </div>
                                    <div class="product-info clearfix">
                                        <span class="product-title">Cotton White Underweaer Block Out Edition</span>
                                ...
                                <li class="product-item man accessories">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="{{url('frontend/images/shop/sh-4/8.jpg')}}" alt="image">
                                        </a>
                                        <span class="new">New</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <div class="owl-carousel owl-theme">
                                    <article class="post clearfix">
                                        <div class="featured-post data-effect-item">
                                            <img src="{{url('frontend/images/blog/new-lastest-1-370x280.jpg')}}" alt="image">
                                    ...
                                    <article class="post clearfix">
                                        <div class="featured-post data-effect-item">
                                            <img src="{{url('frontend/images/blog/new-lastest-2-370x280.jpg')}}" alt="image">
                                            <div class="content-post text-center">
                                                <div class="title-post">
                                                    <h2><a href="blog-detail.html">Trend Of 2018</a></h2>
                                                </div><!-- /.title-post -->
                                    ...
                                    <article class="post clearfix">
                                        <div class="featured-post data-effect-item">
                                            <img src="{{url('frontend/images/blog/new-lastest-3-370x280.jpg')}}" alt="image">
                                            <div class="content-post text-center">
                                                <div class="title-post">
                                                    <h2><a href="blog-detail.html">Trend Of 2018</a></h2>
                                                </div><!-- /.title-post -->
